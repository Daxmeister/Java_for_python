...
public class Lab5_new_attempt {
    ...
    private static void addIfInMatrix(CustomPair coordinates, Queue<CustomPair> queue) {
        ...
        if (inputMatrix[rowCoord][colCoord] != 0 && rowCoord >= 0 && rowCoord < inputMatrix.length && colCoord >= 0 && colCoord < inputMatrix[0].length && inputMatrix[rowCoord][colCoord] == currentChar) {
            queue.offer(coordinates);
